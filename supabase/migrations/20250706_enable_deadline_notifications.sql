-- Enable deadline notification functionality
-- This migration ensures the deadline notification functions exist and work properly

-- Create a simple function to get voters for a post
...
-- Simplified deadline notification function
