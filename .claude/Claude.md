...
- 投票結果の票数表示改善 (GitHub Issue #26 - Stripe決済機能)
- 説得タイム表示の改善 (GitHub Issue #25 - CSRとSSRの適切な使用)
- 派生質問投票制限ロジック完成 (GitHub Issue #22 - 派生質問のボタン位置検討)
- コメント共感・説得力スコア機能 (GitHub Issue #16 - 保留・一番参考にされているコメント)
- AI機能導入 (GitHub Issue #6 - AIの導入)
- コメント評価システム (GitHub Issue #2 - 共感ポイント・説得力スコア)
